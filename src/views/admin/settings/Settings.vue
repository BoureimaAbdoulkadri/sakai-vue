        ...
        <div class="col-12">
            <div class="flex flex-column md:flex-row md:align-items-center md:justify-content-between gap-4 mb-4">
                <div>
                    ...
                    <span class="text-sm text-muted-color">Configuration de la boutique et du back-office</span>
                </div>
                <div>
                    <Button label="Enregistrer" icon="pi pi-check" :disabled="!canSave" :loading="saving" severity="primary" @click="saveSettings" />
                </div>
            </div>
        </div>
                ...
                <template #content>
                    ...
                    <div v-else class="grid formgrid p-fluid">
                        ...
                        <div class="col-12">
                            ...
                            <InputText id="slug" v-model="form.slug" placeholder="Identifiant URL" @input="markDirty" />
                        </div>
                ...
                <template #content>
                    ...
                    <div v-else class="grid formgrid p-fluid">
                        <div class="col-12 md:col-6">
                            ...
                            <Select id="default_locale" v-model="form.default_locale" :options="localeOptions" optionLabel="label" optionValue="value" @change="markDirty" />
                        </div>
                        <div class="col-12 md:col-6">
                            <label for="timezone" class="font-semibold">Fuseau horaire</label>
                            <Select id="timezone" v-model="form.timezone" :options="timezoneOptions" optionLabel="label" optionValue="value" @change="markDirty" />
                        </div>
                        <div class="col-12 md:col-6">
                            <label for="currency" class="font-semibold">Devise</label>
                            <Select id="currency" v-model="form.currency" :options="currencyOptions" optionLabel="label" optionValue="value" @change="markDirty" />
                        </div>
                    </div>
                </template>
            </Card>
                ...
                <template #content>
                    ...
                    <div v-else class="grid formgrid p-fluid">
                        <div class="col-12">
                            ...
                            <InputText id="logo_url" v-model="form.logo_url" placeholder="https://..." @input="markDirty" />
                            <div class="mt-3">
                                <img v-if="form.logo_url" :src="form.logo_url" alt="Logo" style="max-width: 160px; max-height: 80px; object-fit: contain" />
